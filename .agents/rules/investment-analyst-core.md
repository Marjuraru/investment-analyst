...
Contabilizar e inspeccionar el diff material completo, mapear acceptance/invariantes/negativos y
verificar SHA exacto, marker BUILD único PASS, CI, smoke, reviews/threads, alcance, secretos y
trabajo protegido. Gates o filenames no demuestran corrección semántica. No repetir una suite verde
sin riesgo concreto. Sólo `/audit` o `$audit` puede reconciliar y publicar el marker AUDIT único.
