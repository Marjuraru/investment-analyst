...
4. Crear un delta compacto: ID, objetivo, Scope/Risk/Profile, `finalize_policy`, base remota exacta, rama y writer role válido definido por el protocolo, semantic scope o strict allowlist, invariantes, protected/forbidden surfaces con SHA-256 y el formato parser-owned, aceptación/negativos, capability delta y gates/excepciones. Modelo, cliente, harness o comando sólo son metadata de evidencia y nunca definen autoridad, permisos o gates. R3 o superficie sensible requiere strict allowlist; una ruta de gobernanza requiere policy HUMAN.
