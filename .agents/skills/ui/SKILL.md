---
name: ui
description: Ejecuta BUILD como UI Worker Gemini persistente para Work Blocks de interfaz; requiere /ui y nunca crea una vía paralela.
---
...
3. Ejecutar el capability preflight sin mostrar secretos. `/ui` no instala al Worker ni amplía autoridad: el repo, Issue, PR y GitHub siguen siendo la fuente de verdad.
