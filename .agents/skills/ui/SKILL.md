...
3. Ejecutar el capability preflight sin mostrar secretos. La invocación del rol UI_WORKER resuelve un rol con permisos BUILD restringidos por la allowlist; modelo/cliente no amplía ni reduce autoridad y el repo, Issue, PR y GitHub siguen siendo la fuente de verdad.
