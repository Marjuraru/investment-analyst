---
name: ui
description: Ejecuta BUILD como UI_WORKER para Work Blocks de interfaz; requiere /ui y nunca crea una vía paralela.
---
...
3. Ejecutar el capability preflight sin mostrar secretos. `/ui` resuelve un rol con permisos BUILD restringidos por la allowlist; modelo/cliente no amplía ni reduce autoridad y el repo, Issue, PR y GitHub siguen siendo la fuente de verdad.
...
6. Mantener el mismo branch/PR draft, marker BUILD exact-SHA, gates, smoke, auditoría y FINALIZE que BUILD; releer GitHub después de cada mutación y usar scratch externo al worktree con limpieza verificable.
