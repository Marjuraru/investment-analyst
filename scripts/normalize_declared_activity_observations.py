#!/usr/bin/env python3
# ruff: noqa: E501
"""Normalize declared insider and 13D/13G activity into append-only observations."""

import argparse
from datetime import UTC, datetime

from investment_analyst.application.cazatiburones_activity_observations import (
    CazatiburonesActivityObservationsApplication,
)
...
def main() -> None:
    ...
    result = CazatiburonesActivityObservationsApplication.create_default().normalize(
