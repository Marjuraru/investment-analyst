#!/usr/bin/env python3
"""Compute append-only declared 13F position-value weights in an explicit workspace."""
...
def main() -> None:
    ...
    result = CazatiburonesInstitutionalWeightApplication.create_default().compute(
