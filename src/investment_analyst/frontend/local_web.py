...
_ASSETS = {
    ...
    "/assets/app-analysis.js": ("app-analysis.js", "text/javascript; charset=utf-8"),
    "/assets/app-technical.js": ("app-technical.js", "text/javascript; charset=utf-8"),
    "/assets/app-operations.js": ("app-operations.js", "text/javascript; charset=utf-8"),
    "/assets/app-mesa.js": ("app-mesa.js", "text/javascript; charset=utf-8"),
    "/assets/app-cazatiburones.js": ("app-cazatiburones.js", "text/javascript; charset=utf-8"),
    "/assets/app-shell.js": ("app-shell.js", "text/javascript; charset=utf-8"),
    "/assets/app.js": ("app.js", "text/javascript; charset=utf-8"),
    "/assets/tokens.css": ("tokens.css", "text/css; charset=utf-8"),
    "/assets/styles-foundation.css": ("styles-foundation.css", "text/css; charset=utf-8"),
    "/assets/styles-shell.css": ("styles-shell.css", "text/css; charset=utf-8"),
    "/assets/styles-mesa.css": ("styles-mesa.css", "text/css; charset=utf-8"),
    "/assets/styles-analysis.css": ("styles-analysis.css", "text/css; charset=utf-8"),
    "/assets/styles-technical.css": ("styles-technical.css", "text/css; charset=utf-8"),
    "/assets/styles-operations.css": ("styles-operations.css", "text/css; charset=utf-8"),
    "/assets/styles-cazatiburones.css": ("styles-cazatiburones.css", "text/css; charset=utf-8"),
...
class _ApplicationOperations(Protocol):
    ...
    def refresh_crypto_spot_daily(
        ...
        *,
        ...
        """Refresh one configured Coinbase daily source."""
        ...
...
class AaplLocalController:
    ...
    def crypto_spot_daily_market_chart_request(
        ...
        """Query a cached catalog-scoped Coinbase daily chart without writes."""
        with self._cache_lock:
            cached = self._crypto_spot_daily_chart_cache.get(request)
            if cached is not None:
                return cached
        chart = self._application.query_crypto_spot_daily_market_chart(
            request,
            location=StorageLocationRequest(workspace=self._workspace),
        )
        with self._cache_lock:
            if len(self._crypto_spot_daily_chart_cache) >= _MAX_READ_CACHE_ENTRIES:
                self._crypto_spot_daily_chart_cache.pop(
                    next(iter(self._crypto_spot_daily_chart_cache))
                )
    ...
    def crypto_spot_daily_refresh_request(
        ...
        """Execute one catalog-scoped Coinbase daily refresh through the writer mutex."""
        with self._writer_lock:
            try:
                return self._application.refresh_crypto_spot_daily(
                    request,
                    location=StorageLocationRequest(workspace=self._workspace),
                )
            finally:
