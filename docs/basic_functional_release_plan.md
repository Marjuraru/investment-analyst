...
La transicion integrada registra LOCAL-INTERFACE DONE por UI-14/#202 (route_effect: COMPLETES); EQUITY-UNIVERSE permanece PLANNED, SEC-CORPUS es el unico NEXT, BVL sigue BLOCKED y PREDICTIVE-RESEARCH sigue DEFERRED.
Este candidato propone route_effect: ADVANCES sobre SEC-CORPUS; el item permanece NEXT y `SEC-CORPUS-30` queda como la siguiente unidad registrada.
Transicion de ruta propuesta: route_transition:SEC-CORPUS:ADVANCES.
