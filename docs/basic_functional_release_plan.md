...
| `SEC-CORPUS` | `NEXT` | #134/#135 integraron correspondencia y observaciones 13F; #140 integró composición/completitud, #142 métricas de cambio reportado, #144 peso declarado y #146 concentración efímera. #151 añade eventos institucionales descriptivos persistidos (`cazatiburones_institutional_events_v1`), candidatos con cooldown de 24h y consulta reproducible por snapshot_id; #153 añade notificación local deduplicada y reanudable de candidatos elegibles de ambas verticales. Pendientes: cartera efectiva, reglas complejas, búsqueda y UI. | Las observaciones 13F son filas as-filed separadas; peso, concentración, eventos y notificaciones usan el universo as-filed del cierre efectivo, nunca una cartera efectiva. La outbox local conserva familias separadas y no es señal, recomendación ni canal externo. No hay percentil robusto ni capa 4. |
