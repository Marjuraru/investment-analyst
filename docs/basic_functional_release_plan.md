...
| `SEC-CORPUS` | `NEXT` | Correspondencia 13F declarada y PIT integrada; cambios descriptivos y baseline robusto en curso. | Las posiciones 13F conservan CUSIP y clase declarados sin `asset_id`. |
