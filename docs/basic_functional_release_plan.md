...
| `SEC-CORPUS` | `NEXT` | Correspondencia 13F declarada y PIT integrada; faltan métricas descriptivas separadas. | Las posiciones 13F conservan CUSIP y clase declarados sin `asset_id`. |
