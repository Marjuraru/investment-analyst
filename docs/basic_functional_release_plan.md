...
| `SEC-CORPUS` | `NEXT` | Correspondencia 13F PIT y features descriptivas read-only para 13F, insiders y 13D/13G integradas; faltan reglas por formulario, eventos y panel. | Las posiciones 13F conservan CUSIP y clase declarados sin `asset_id`. |
