...
| `SEC-CORPUS` | `NEXT` | #134/#135 integraron correspondencia y observaciones 13F; #140 integró composición/completitud y este bloque añade métricas descriptivas persistidas. Pendientes: concentración/cartera efectiva, eventos, reglas/automatización, búsqueda y UI. | Las observaciones 13F son filas as-filed separadas, no cartera efectiva; no hay composición de enmiendas, concentración, percentil robusto ni capa 4. |
