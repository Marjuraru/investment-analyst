...
| `SEC-CORPUS` | `NEXT` | Siguiente vertical documental pendiente de planificación. | Forms 3/4/5 integrados con semántica PIT corregida; 13D/13G y 13F no integrados. |
